...
; Generated by BLU Auto Quote v10.1.2 - BLU Web Mode
...
RunQuote() {
  global quote, WEB_LCL, WEB_IMPORT, WEB_TARGET_CURRENCY, SavedClipboard, ROW_DELAY, TAB_DELAY, CARGO_DETAILS_TAB_DELAY
  CheckWebEnvironment()
  ActivateBluWeb()
...
WebReady(name) {
  ...
  key := StrLower(name)
  ; Preserve client +1000 ms; route searches get another +1500 ms before Enter.
...
`;
  ...
  installModeUi();
  window.BLU_AUTO_QUOTE_V1012 = window.BLU_AUTO_QUOTE_V1011 = window.BLU_AUTO_QUOTE_V1010 = window.BLU_AUTO_QUOTE_V1000 = Object.freeze({
