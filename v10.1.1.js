...
; Generated by BLU Auto Quote v10.1.1 - BLU Web Mode
...
; Charge offsets: 0,11,24,35,46,57; charge 7+ stays at charge 6 (57 px).
...
WebReady(name) {
  ...
  key := StrLower(name)
  ; Client and route searches need one extra second AFTER typing, before Enter.
  ; Keep the existing menu wait and all other field-specific waits unchanged.
  if key = "client fhb" || key = "plor loc code" || key = "polout loc code" || key = "podin loc code" || key = "plod loc code"
...
`;
  ...
  installModeUi();
  window.BLU_AUTO_QUOTE_V1011 = window.BLU_AUTO_QUOTE_V1010 = window.BLU_AUTO_QUOTE_V1000 = Object.freeze({
